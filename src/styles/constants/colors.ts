...
export const SHADOWS = {
  ...
  button: "0 4px 16px rgba(255, 68, 68, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
  buttonHover: "0 6px 20px rgba(255, 68, 68, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
  contentBox: "0 8px 32px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
